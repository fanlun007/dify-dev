...
import { RiComputerLine, RiDeleteBinLine, RiEditLine, RiLock2Line } from '@remixicon/react'
    ...
    <div className={cn(
      ...
      <div className='flex items-center justify-between'>
        <div className='grow flex gap-1 items-center'>
          ...
          {env.value_type === 'os' && <RiComputerLine className='w-3 h-3 text-text-tertiary' />}
        </div>
